...
.. code:: python
  ...
  profile_dives(data, animal_length, folder=None, columns={'depth': 'depth', 'time': 'time'}, acceleration_threshold=0.015, ipython_display_mode=False)


The dive data can either be displayed to the user in Jupyter Notebooks or stored in files.
...
.. code:: python
  ...
  #Store in files
  profile_dives(df, folder='result')
